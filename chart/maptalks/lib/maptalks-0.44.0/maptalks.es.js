...
var Map$1 = function (_Handlerable) {
  ...
  _proto.getDevicePixelRatio = function getDevicePixelRatio() {
    return this.options['devicePixelRatio'] || Math.ceil(Browser$1.devicePixelRatio);
  };
